...
package com.infomaniak.multiplatform_authenticator.buildlogic.publish
            ...
            extensions.configure<PublishingExtension> {
                publications {
                    withType<MavenPublication> {
                        pom {
                            name.set("MultiplatformAuthenticator")
                            description.set("Multiplatform Authenticator - MultiplatformAuthenticator core library")
                            licenses {
                                license {
                                    name.set("GPL-3.0")
                            ...
                            url.set("https://github.com/Infomaniak/multiplatform-authenticator")
                            issueManagement {
                                system.set("Github")
                                url.set("https://github.com/Infomaniak/multiplatform-authenticator/issues")
                            }
                            scm {
                                connection.set("https://github.com/Infomaniak/multiplatform-authenticator.git")
                                url.set("https://github.com/Infomaniak/multiplatform-authenticator")
                            }
                            organization {
